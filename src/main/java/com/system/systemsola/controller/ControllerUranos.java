...
public class ControllerUranos {
	...
	@PutMapping("{id}")
	public ResponseEntity<UranosDTO> update(@PathVariable Long id, @RequestBody UranosDTO uranosDTO) {
		return service.update(id, uranosDTO);
	}
	
	@DeleteMapping("{id}")
	public ResponseEntity<UranosDTO> update(@PathVariable Long id) {
